...
--
-- Machine: 127.0.0.1
-- Gegenereerd op: 27 feb 2017 om 14:03
-- Serverversie: 5.6.21
-- PHP-versie: 5.6.3
...
--
-- Databank: `banksysteem`
--

-- --------------------------------------------------------

--
-- Tabelstructuur voor tabel `acc`
--
...
--
-- AUTO_INCREMENT voor een tabel `acc`
--
ALTER TABLE `acc`
...
--
-- Gegevens worden geëxporteerd voor tabel `cds`
--
...
--
-- AUTO_INCREMENT voor een tabel `cds`
--
ALTER TABLE `cds`
MODIFY `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=7;--
-- Databank: `imagetesten`
--

-- --------------------------------------------------------

--
-- Tabelstructuur voor tabel `test_image`
--
...
--
-- AUTO_INCREMENT voor een tabel `test_image`
--
ALTER TABLE `test_image`
MODIFY `id` int(10) NOT NULL AUTO_INCREMENT;--
-- Databank: `instructieboek`
--
--
-- Databank: `mpmodel`
--
...
(1, 'apple', 'touch', 50000, '399.99', 600),
...
--
-- Tabelstructuur voor tabel `pma_bookmark`
--
...
--
-- Tabelstructuur voor tabel `pma_column_info`
--
...
--
-- Gegevens worden geëxporteerd voor tabel `pma_column_info`
--

INSERT INTO `pma_column_info` (`id`, `db_name`, `table_name`, `column_name`, `comment`, `mimetype`, `transformation`, `transformation_options`) VALUES
(1, 'mpmodel', 'mpmodel', 'id', '', '', '_', ''),
(2, 'mpmodel', 'mpmodel', 'make', '', '', '_', ''),
(3, 'mpmodel', 'mpmodel', 'model', '', '', '_', ''),
(4, 'mpmodel', 'mpmodel', 'mbsize', '', '', '_', ''),
(5, 'mpmodel', 'mpmodel', 'price', '', '', '_', ''),
(6, 'mpmodel', 'mpmodel', 'voorraad', '', '', '_', ''),
(7, 'banksysteem', 'Bank', 'id', '', '', '_', ''),
(16, 'banksysteem', 'acc', 'user_id', '', '', '_', ''),
(15, 'banksysteem', 'acc', 'id', '', '', '_', ''),
(17, 'banksysteem', 'acc', 'balans', '', '', '_', ''),
(18, 'banksysteem', 'users', 'id', '', '', '_', ''),
(30, 'imagetesten', 'test_image', 'name', '', '', '_', ''),
(31, 'imagetesten', 'test_image', 'image', '', '', '_', ''),
(29, 'imagetesten', 'test_image', 'id', '', '', '_', ''),
(23, 'vekabestwebsite', 'boeken', 'boekid', '', '', '_', ''),
(24, 'vekabestwebsite', 'boeken', 'boekprijs', '', '', '_', ''),
(25, 'vekabestwebsite', 'boeken', 'boekafbeelding', '', '', '_', ''),
(26, 'vekabestwebsite', 'boeken', 'boeknaam', '', '', '_', ''),
(27, 'vekabestwebsite', 'boeken', 'boeksoort', '', '', '_', ''),
(28, 'vekabestwebsite', 'boeken', 'boeksku', '', '', '_', '');

-- --------------------------------------------------------

--
-- Tabelstructuur voor tabel `pma_designer_coords`
--
...
--
-- Tabelstructuur voor tabel `pma_history`
--
...
--
-- Tabelstructuur voor tabel `pma_navigationhiding`
--
...
--
-- Tabelstructuur voor tabel `pma_pdf_pages`
--
...
--
-- Tabelstructuur voor tabel `pma_recent`
--
...
--
-- Gegevens worden geëxporteerd voor tabel `pma_recent`
--

INSERT INTO `pma_recent` (`username`, `tables`) VALUES
('root', '[{"db":"vekabestwebsite","table":"boeken"},{"db":"imagetesten","table":"test_image"},{"db":"mpmodel","table":"mpmodel"},{"db":"banksysteem","table":"users"},{"db":"banksysteem","table":"acc"},{"db":"cdcol","table":"cds"},{"db":"world","table":"country"},{"db":"world","table":"countrylanguage"},{"db":"world","table":"city"},{"db":"phpmyadmin","table":"pma_bookmark"}]');

-- --------------------------------------------------------

--
-- Tabelstructuur voor tabel `pma_relation`
--
...
--
-- Tabelstructuur voor tabel `pma_savedsearches`
--
...
--
-- Tabelstructuur voor tabel `pma_table_coords`
--
...
--
-- Tabelstructuur voor tabel `pma_table_info`
--
...
--
-- Tabelstructuur voor tabel `pma_table_uiprefs`
--
...
--
-- Gegevens worden geëxporteerd voor tabel `pma_table_uiprefs`
--

INSERT INTO `pma_table_uiprefs` (`username`, `db_name`, `table_name`, `prefs`, `last_update`) VALUES
('root', 'mpmodel', 'mpmodel', '{"sorted_col":"`id` ASC"}', '2016-03-24 11:27:29'),
('root', 'vekabestwebsite', 'boeken', '[]', '2017-02-21 14:18:15');

-- --------------------------------------------------------

--
-- Tabelstructuur voor tabel `pma_tracking`
--
...
--
-- Tabelstructuur voor tabel `pma_userconfig`
--
...
--
-- Gegevens worden geëxporteerd voor tabel `pma_userconfig`
--

INSERT INTO `pma_userconfig` (`username`, `timevalue`, `config_data`) VALUES
('root', '2016-03-15 11:11:10', '{"lang":"nl","collation_connection":"utf8mb4_general_ci"}');

-- --------------------------------------------------------

--
-- Tabelstructuur voor tabel `pma_usergroups`
--
...
--
-- Tabelstructuur voor tabel `pma_users`
--
...
--
-- Indexen voor tabel `pma_bookmark`
--
ALTER TABLE `pma_bookmark`
 ADD PRIMARY KEY (`id`);

--
-- Indexen voor tabel `pma_column_info`
--
ALTER TABLE `pma_column_info`
 ADD PRIMARY KEY (`id`), ADD UNIQUE KEY `db_name` (`db_name`,`table_name`,`column_name`);

--
-- Indexen voor tabel `pma_designer_coords`
--
ALTER TABLE `pma_designer_coords`
 ADD PRIMARY KEY (`db_name`,`table_name`);

--
-- Indexen voor tabel `pma_history`
--
ALTER TABLE `pma_history`
 ADD PRIMARY KEY (`id`), ADD KEY `username` (`username`,`db`,`table`,`timevalue`);

--
-- Indexen voor tabel `pma_navigationhiding`
--
ALTER TABLE `pma_navigationhiding`
 ADD PRIMARY KEY (`username`,`item_name`,`item_type`,`db_name`,`table_name`);

--
-- Indexen voor tabel `pma_pdf_pages`
--
ALTER TABLE `pma_pdf_pages`
 ADD PRIMARY KEY (`page_nr`), ADD KEY `db_name` (`db_name`);

--
-- Indexen voor tabel `pma_recent`
--
ALTER TABLE `pma_recent`
 ADD PRIMARY KEY (`username`);

--
-- Indexen voor tabel `pma_relation`
--
ALTER TABLE `pma_relation`
 ADD PRIMARY KEY (`master_db`,`master_table`,`master_field`), ADD KEY `foreign_field` (`foreign_db`,`foreign_table`);

--
-- Indexen voor tabel `pma_savedsearches`
--
ALTER TABLE `pma_savedsearches`
 ADD PRIMARY KEY (`id`), ADD UNIQUE KEY `u_savedsearches_username_dbname` (`username`,`db_name`,`search_name`);

--
-- Indexen voor tabel `pma_table_coords`
--
ALTER TABLE `pma_table_coords`
 ADD PRIMARY KEY (`db_name`,`table_name`,`pdf_page_number`);

--
-- Indexen voor tabel `pma_table_info`
--
ALTER TABLE `pma_table_info`
 ADD PRIMARY KEY (`db_name`,`table_name`);

--
-- Indexen voor tabel `pma_table_uiprefs`
--
ALTER TABLE `pma_table_uiprefs`
 ADD PRIMARY KEY (`username`,`db_name`,`table_name`);

--
-- Indexen voor tabel `pma_tracking`
--
ALTER TABLE `pma_tracking`
 ADD PRIMARY KEY (`db_name`,`table_name`,`version`);

--
-- Indexen voor tabel `pma_userconfig`
--
ALTER TABLE `pma_userconfig`
 ADD PRIMARY KEY (`username`);

--
-- Indexen voor tabel `pma_usergroups`
--
ALTER TABLE `pma_usergroups`
 ADD PRIMARY KEY (`usergroup`,`tab`,`allowed`);

--
-- Indexen voor tabel `pma_users`
--
...
--
-- AUTO_INCREMENT voor een tabel `pma_bookmark`
--
ALTER TABLE `pma_bookmark`
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT voor een tabel `pma_column_info`
--
ALTER TABLE `pma_column_info`
MODIFY `id` int(5) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=32;
--
-- AUTO_INCREMENT voor een tabel `pma_history`
--
ALTER TABLE `pma_history`
MODIFY `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT voor een tabel `pma_pdf_pages`
--
ALTER TABLE `pma_pdf_pages`
MODIFY `page_nr` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT voor een tabel `pma_savedsearches`
--
ALTER TABLE `pma_savedsearches`
...
--
-- Tabelstructuur voor tabel `user_pwd`
--
...
--
-- Gegevens worden geëxporteerd voor tabel `user_pwd`
--
...
--
-- Tabelstructuur voor tabel `countrylanguage`
--
...
--
-- Gegevens worden geëxporteerd voor tabel `countrylanguage`
--
...
--
-- Indexen voor tabel `countrylanguage`
--
...
--
-- Beperkingen voor tabel `countrylanguage`
--
ALTER TABLE `countrylanguage`
