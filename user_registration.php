...
<div class="opvulling">
    ...
    <a href="http://localhost/VekaBest/index.php">
        <button type="button" class="btn"><span class="glyphicon glyphicon-home"></span>Home</button>
    </a>
    <?php
    ...
    if (isset($_POST['submit'])) {
        ...
        if ($Password == $RePassword) {
            ...
            if ($count == 1) {
                ...
                $result = mysqli_query($Connect, $sql);
                $sql1 = "INSERT INTO `user_info`(`id`, `adres`, `huisnummer`, `postcode`, `plaatsnaam`, `telefoon`, `voornaam`, `achternaam`) VALUES ('$Id','$Adres','$HuisNummer','$PostCode', '$Plaats', '$TelefoonNummer', '$VoorNaam', '$AchterNaam')";
                $result1 = mysqli_query($Connect, $sql1);
